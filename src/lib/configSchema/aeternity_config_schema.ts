// Json schema downloaded from https://raw.githubusercontent.com/aeternity/aeternity/refs/tags/v7.3.0-rc4/apps/aeutils/priv/aeternity_config_schema.json
...
export const aeternityConfigSchemaSchema = z.object({
  ...
  sync: z
    .object({
       ...
       */
      minimum_ping_version: z.number().optional(),
      /**
      ...
      ping: z
        .object({
           ...
           */
          peer_percentage: z.number().optional(),
        })
        .optional(),
      peer_pool: z
        .object({
  ...
  chain: z
    .object({
       ...
       */
      genesis_accounts: z.record(z.number()).optional(),
      /**
       ...
       */
      db_safe_access: z.boolean().optional(),
      /**
       * @deprecated
          ...
          z.union([
            ...
            z.record(z.unknown()).and(
              z.object({
                 ...
                 */
                extra_accounts_file: z.string().optional(),
                /**
                 * File where contracts are stored
                 */
                contracts_file: z.string().optional(),
              })
            ),
          ])
        )
      ...
      currency: z
        .object({
           ...
           * Subunits per unit.
           */
          subunits_per_unit: z.number().optional(),
          /**
           * @deprecated
           * Use `fiat_conversion_url` instead
           */
          fiat_converstion_url: z.string().optional(),
          /**
           * URL of the fiat conversion.
           */
          fiat_conversion_url: z.string().optional(),
        })
        .optional(),
      display: z
        .object({
              ...
              config: z
                ...
                .and(
                  z.object({
                     ...
                     */
                    default_pinning_behavior: z.boolean().optional(),
                    /**
                     ...
                     */
                    fee_distribution: z.array(z.number()).optional(),
                    /**
      ...
      protocol_beneficiaries: z.array(z.record(z.unknown())).optional(),
